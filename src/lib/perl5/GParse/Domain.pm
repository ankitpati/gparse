...
Preffered means of interacting with the new L<GParse::Domain>; the old way is
only provided for compatibility and should be removed later as it comes with a
performance penalty.
